...
% positive
f11 = fii(1,1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
f12 = fii(1,2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
f21 = fii(2,1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
f22 = fii(2,2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

% negative (m)
fm1m1 = fii(-1,-1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm1m2 = fii(-1,-2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm2m1 = fii(-2,-1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm2m2 = fii(-2,-2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

% positive and negative:
f1m1 = fii(1,-1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm11 = fii(-1,1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

fm21 = fii(-2,1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
f1m2 = fii(1,-2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

f2m1 = fii(2,-1, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm12 = fii(-1,2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

f2m2 = fii(2,-2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
fm22 = fii(-2,2, h, r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);
...
parameters;
type = 'scaled'; % scaled: g(z,a)
[sol_AShock, sol_BShock] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,type,theta);

figure;
plot(sol_BShock.x, sol_BShock.y(1,:))
title('First Best Firm Value Before Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/FB_B_Shock.eps'],'epsc')

figure;
plot(sol_AShock.x, sol_AShock.y(1,:))
title('First Best Firm Value After Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/FB_A_Shock.eps'],'epsc')
...
h_tau = tau*0.5; % change in lambda
...
% Filling in the formula for finite difference (see notes)
[~, sol_BShock_1] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega+h_omega,type,theta);
[~, sol_BShock_2] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega-h_omega,type,theta);
[~, sol_BShock_3] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega+h_omega,type,theta);
[~, sol_BShock_4] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega-h_omega,type,theta);
...
title('First Best $\frac{\partial a}{\partial \tau \partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/fb_da_dtau_domega.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BShock_1] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega+h_omega,type,theta);
[~, sol_BShock_2] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega-h_omega,type,theta);
[~, sol_BShock_3] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega+h_omega,type,theta);
[~, sol_BShock_4] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega-h_omega,type,theta);
...
title('First Best $\frac{\partial a}{\partial \lambda \partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/fb_da_dlambda_domega.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BShock_1] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda+2*h_lambda,omega,type,theta);
[~, sol_BShock_2] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega,type,theta);
[~, sol_BShock_3] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega,type,theta);
[~, sol_BShock_4] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda-2*h_lambda,omega,type,theta);
...
title('First Best $\frac{\partial a}{\partial \lambda}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/fb_da_dlambda.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BShock_1] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega+2*h_omega,type,theta);
[~, sol_BShock_2] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega+h_omega,type,theta);
[~, sol_BShock_3] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega-h_omega,type,theta);
[~, sol_BShock_4] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega-2*h_omega,type,theta);
...
title('First Best $\frac{\partial a}{\partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/fb_da_omega.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BShock_1] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau+2*h_tau,sigma,a_bar,lambda,omega,type,theta);
[~, sol_BShock_2] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega,type,theta);
[~, sol_BShock_3] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega,type,theta);
[~, sol_BShock_4] = solve_ODE_SAR_FB(r,mu_B,mu_G,tau-2*h_tau,sigma,a_bar,lambda,omega,type,theta);
...
% Step 5: compute central finite difference
derivative_tau = @(z) (-BShock_fun1(z) + 8*BShock_fun2(z) - 8*BShock_fun3(z) + BShock_fun4(z)) / 12*h_tau;

figure('name', 'Numerical derivative omega')
fplot(derivative_tau, [0.1 0.9])
...
derivative_tau_fb = (-m_ShockB_1 + 8*m_ShockB_2 - 8*m_ShockB_3 + m_ShockB_4) / 12*h_tau;

figure('name', '(MAKIMA) Numerical derivative tau first best')
plot(xq,derivative_tau_fb)
title('First Best $\frac{\partial a}{\partial \tau}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_fb/fb_da_dtau.eps'],'epsc')

save('derivative_tau_fb.mat','derivative_tau_fb')

%% Solve Agency Friction Model With Stranded Asset Risk and Green Preferences
parameters;
type='scaled';
[sol_A_Agency, sol_B_Agency] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega,gamma,type,theta);

figure;
plot(sol_B_Agency.x,sol_B_Agency.y(1,:))
title('Moral Hazard Firm Value Before Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_B_Shock.eps'],'epsc')

figure;
plot(sol_A_Agency.x,sol_A_Agency.y(1,:))
title('Moral Hazard Firm Value Before Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_A_Shock.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BAgency_1] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda+2*h_lambda,omega,gamma,type,theta);
[~, sol_BAgency_2] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega,gamma,type,theta);
[~, sol_BAgency_3] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega,gamma,type,theta);
[~, sol_BAgency_4] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda-2*h_lambda,omega,gamma,type,theta);
...
title('Moral Hazard $\frac{\partial a}{\partial \lambda}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_da_dlambda.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BAgency_1] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega+2*h_omega,gamma,type,theta);
[~, sol_BAgency_2] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega+h_omega,gamma,type,theta);
[~, sol_BAgency_3] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega-h_omega,gamma,type,theta);
[~, sol_BAgency_4] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda,omega-2*h_omega,gamma,type,theta);
...
title('Moral Hazard $\frac{\partial a}{\partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_da_domega.eps'],'epsc')

save('derivative_omega_agency.mat','derivative_omega_agency')



% Compute Numerical Derivative Tau Agency Friction Model

parameters;
% Step 1: define step sizes
h_tau = tau*0.5; % change in omega

% Step 2: compute the four value functions for different parameters
type = 'scaled'; % scaled: g(z,a)

% Filling in the formula for finite difference (see notes)
[~, sol_BAgency_1] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau+2*h_tau,sigma,a_bar,lambda,omega,gamma,type,theta);
[~, sol_BAgency_2] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega,gamma,type,theta);
[~, sol_BAgency_3] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega,gamma,type,theta);
[~, sol_BAgency_4] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau-2*h_tau,sigma,a_bar,lambda,omega,gamma,type,theta);
...
% Step 5: compute central finite difference
derivative_omega = @(z) (-BAgency_fun1(z) + 8*BAgency_fun2(z) - 8*BAgency_fun3(z) + BAgency_fun4(z)) / 12*h_tau;
...
derivative_tau_agency = (-m_agencyB_1 + 8*m_agencyB_2 - 8*m_agencyB_3 + m_agencyB_4) / 12*h_tau;

figure('name', '(MAKIMA) Numerical derivative tau agency')
plot(xq,derivative_tau_agency)
title('Moral Hazard $\frac{\partial a}{\partial \tau}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_da_dtau.eps'],'epsc')

save('derivative_tau_agency.mat','derivative_tau_agency')

%% Compute Numerical Cross Derivative Tau Omega Agency Friction Model

parameters;
% Step 1: define step sizes
h_tau = tau*0.5; % change in tau
h_omega = omega*0.25; % change in omega
...
% Filling in the formula for finite difference (see notes)
[~, sol_BAgency_1] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega+h_omega,gamma,type,theta);
[~, sol_BAgency_2] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega+h_omega,gamma,type,theta);
[~, sol_BAgency_3] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau+h_tau,sigma,a_bar,lambda,omega-h_omega,gamma,type,theta);
[~, sol_BAgency_4] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau-h_tau,sigma,a_bar,lambda,omega-h_omega,gamma,type,theta);
...
title('Moral Hazard $\frac{\partial a}{\partial \tau \partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_da_dtau_domega.eps'],'epsc')
...
hold on
plot(xq,cross_tau_omega_agency)
title('Comparison $\frac{\partial a}{\partial \tau \partial \omega}$', 'interpreter','latex')
legend('First Best', 'Moral Hazard')
grid on
saveas(gca,[pwd '/figures/results_comparison/comparison_da_dtau_domega.eps'],'epsc')
...
% Filling in the formula for finite difference (see notes)
[~, sol_BAgency_1] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega+h_omega,gamma,type,theta);
[~, sol_BAgency_2] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega+h_omega,gamma,type,theta);
[~, sol_BAgency_3] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda+h_lambda,omega-h_omega,gamma,type,theta);
[~, sol_BAgency_4] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda-h_lambda,omega-h_omega,gamma,type,theta);
...
title('Moral Hazard $\frac{\partial a}{\partial \lambda \partial \omega}$', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_agency/agency_da_dlambda_domega.eps'],'epsc')

save('cross_derivative_agency.mat','cross_lambda_omega_agency')

%% Plot comparison cross derivative lambda under fb and agency
...
hold on
plot(xq,cross_lambda_omega_agency)
title('Comparison $\frac{\partial a}{\partial \lambda \partial \omega}$', 'interpreter','latex')
legend('First Best', 'Moral Hazard')
grid on
saveas(gca,[pwd '/figures/results_comparison/comparison_da_dlambda_domega.eps'],'epsc')
...
hold on
plot(xq,derivative_omega_agency)
title('Comparison $\frac{\partial a}{\partial \omega}$', 'interpreter','latex')
legend('First Best', 'Moral Hazard')
grid on
saveas(gca,[pwd '/figures/results_comparison/comparison_da_domega.eps'],'epsc')
...
hold on
plot(xq,derivative_lambda_agency)
title('Comparison $\frac{\partial a}{\partial \lambda}$', 'interpreter','latex')
legend('First Best', 'Moral Hazard')
grid on
saveas(gca,[pwd '/figures/results_comparison/comparison_da_dlambda.eps'],'epsc')
...
hold on
plot(xq,derivative_tau_agency)
title('Comparison $\frac{\partial a}{\partial \tau}$', 'interpreter','latex')
legend('First Best', 'Moral Hazard')
grid on
saveas(gca,[pwd '/figures/results_comparison/comparison_da_dtau.eps'],'epsc')
...
plot(sol_B_Agency.x, sol_B_Agency.y(1,:))
legend('First Best', 'Moral Hazard')
title('Comparison Firm Values Before Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_comparison/comparison_Bshock.eps'],'epsc')
...
plot(sol_A_Agency.x, sol_A_Agency.y(1,:))
legend('First Best', 'Moral Hazard')
title('Comparison Firm Values After Shock', 'interpreter','latex')
saveas(gca,[pwd '/figures/results_comparison/comparison_Ashock.eps'],'epsc')
