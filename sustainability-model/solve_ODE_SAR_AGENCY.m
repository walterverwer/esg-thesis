function [sol_A, sol_B] = solve_ODE_SAR_AGENCY(r,mu_B,mu_G,tau,sigma,a_bar,lambda1,omega1,gamma1,type)
    ...
    expr_a = matlabFunction(...
        taylor( 1/( gamma*r*sigma^2*x*(1-x) ), x, 'ExpansionPoint',.5,'Order',9));

    ode_fun = @(z,y) odeAShockAgency(z,y,r,mu_G,mu_B,tau,omega,gamma,sigma,expr,expr_a,a_bar,type);
    ...
    guessFun = @(z) guessAShockAgency(z,y0_guess,r,mu_G,mu_B,tau,omega,gamma,sigma,expr,expr_a, a_bar,type);
